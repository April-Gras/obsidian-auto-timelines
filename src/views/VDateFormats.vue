    ...
    <Transition mode="out-in">
      <div class="v-inline-flex-display">
        <VIconButton
          ...
          :has-accent="selectedComponentName === 'VCreateDateFormatFlow'"
          iconType="box"
        >
        ...
        <VIconButton
          ...
          :has-accent="selectedComponentName === 'VSelectDateFormatPreset'"
        ...
        <VIconButton
          ...
          :has-accent="selectedComponentName === 'VAdvancedDateFormats'"
          iconType="settings"
        >
